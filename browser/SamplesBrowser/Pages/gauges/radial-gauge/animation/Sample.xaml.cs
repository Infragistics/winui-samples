...
namespace SamplesBrowser.Pages.Gauges.RadialGauge.Animation;
...
public sealed partial class Sample : UserControl, INotifyPropertyChanged
{
    ...
    public void RadialGaugeAnimateToGauge1(object sender, PropertyEditorPropertyDescriptionButtonClickEventArgs args)
    {
        ...
        gauge.ScaleSweepDirection = Infragistics.Core.Graphics.Media.SweepDirection.Clockwise;
        ...
        gauge.FontFamily = new FontFamily("Verdana");
        gauge.FontSize = 15; 
