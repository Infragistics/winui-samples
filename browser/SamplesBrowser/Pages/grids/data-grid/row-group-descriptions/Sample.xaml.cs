...
namespace SamplesBrowser.Pages.Grids.DataGrid.RowGroupDescriptions;

public sealed partial class Sample : UserControl, INotifyPropertyChanged
{
    public string[] dropDownNames1 { get; } = new string[] { "Combined", "Split" };
    public string[] dropDownValues1 { get; } = new string[] { "Combined", "Split" };
